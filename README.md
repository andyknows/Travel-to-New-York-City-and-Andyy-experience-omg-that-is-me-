...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-color: #e6e6fa; /* Color lila */
            color: #333;
        }
        header {
...
<div class="container">
    <div class="destination">
        <img src="https://cdn.kastatic.org/third_party/javascript-khansrc/live-editor/build/images/cute/Selector.png" alt="NYC image">
    ...
    <h2>Places to Go</h2>
    <ul>
        <li>Brooklyn Bridge - An incredible connection between Manhattan and Brooklyn. (The day I visited it rained a lot and it was very cold. At the end of the bridge, we expected to find keychain sellers, but we only found a hot dog stand after walking more than 2 km LOL. I still enjoyed it.)</li> 
